...
public class ObjectiveFunctionCLL_wf extends ObjectiveFunction {

	public ObjectiveFunctionCLL_wf(wdAnJE algorithm) {
		super(algorithm);
	}
...
//						System.out.println("grad index="+index+"\tfor c="+c+"\ta="+att1+"\tva="+att1val);
						
//						g[index] += (-1) * (SUtils.ind(c, x_C) - myProbs[c]) * dParameters.getXyCount()[index];
