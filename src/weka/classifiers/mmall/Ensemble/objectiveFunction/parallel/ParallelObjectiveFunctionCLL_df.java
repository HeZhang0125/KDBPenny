...
public class ParallelObjectiveFunctionCLL_df extends ObjectiveFunctionCLL_df {
	...
	public ParallelObjectiveFunctionCLL_df(wdAnJE algorithm) {
		super(algorithm);
	...
	public FunctionValues getValues(double params[]) {
		...
		for (int th = 0; th < nThreads; th++) {
			 ...
			 * Calling thread
			 */
			Callable<Double> thread = new CallableCLL_df(start, stop, tmpProbs[th], gs[th], algorithm, th);
