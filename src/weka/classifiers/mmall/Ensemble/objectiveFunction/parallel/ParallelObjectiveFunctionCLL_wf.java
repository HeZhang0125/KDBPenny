...
public class ParallelObjectiveFunctionCLL_wf extends ObjectiveFunctionCLL_wf {
	...
	public ParallelObjectiveFunctionCLL_wf(wdAnJE algorithm) {
		super(algorithm);
	...
	public FunctionValues getValues(double params[]) {
		...
		for (int th = 0; th < nThreads; th++) {
			...
			Callable<Double> thread = new CallableCLL_wf(start, stop, tmpProbs[th], gs[th], algorithm, th);
